...
.
  ...
  plugins/ai-memory/                # plugin cliente do servidor ai-memory
    ...
    scripts/install.sh             # binário + credencial + MCP nos 2 runtimes
```
