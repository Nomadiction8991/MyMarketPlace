...
**Não instale hooks globais** nesta instalação: os templates de autofix globais (Claude e opencode) são apenas para uso standalone via `npx skills add` e não acompanham este plugin.
